...
- `workspace_info` — workspace, активный режим и статус repo context;
...
Запустите `BUILD_RELEASE.bat`. Архив `notion-mcp-easy-<версия>.zip` появится рядом с папкой проекта. Сборщик автоматически исключает `.venv`, кэши, логи, ZIP-файлы, временную папку `temp/`, локальные repo-файлы и файлы конфигурации/токенов.
